...
public class TestCaseC1 {
	
	public static String ID = "C1";
	public static String NAME = "Find unpaid bookings in account and select for each of them payment on arrival";
	...
	public static String CARNAME = "Renault Scenic";
	public static String DESCRIPTION = "The Renault Scénic is a compact multi-purpose vehicle (MPV) produced by French automaker Renault, the first to be labelled as such in Europe. It is based on the chassis of the Mégane small family car. It became the 1997 European Car of the Year on its launch in November 1996. The second and third generations have a model called Grand Scénic, which has seven seats rather than five.";
	...
	public void execute(PrintWriter writer) throws InterruptedException, IOException  {
		...
		System.out.println("TestC1 execution started");
       ...
       // Open cars menu
		...
		selectpickup = new Select(driver.findElement(By.id("pickuplocation")));
		selectpickup.selectByIndex(1);
		selectdrop = new Select(driver.findElement(By.id("droplocation")));
		selectdrop.selectByIndex(0);
		Thread.sleep(3000);
       ...
       // Check invoices status
        ...
        invoices = driver.findElements(By.cssSelector(".btn.btn-action"));
        ...
        System.out.println("TestC1 " + result);
